...
const val XDAI_ENDPOINT = "https://rpc.gnosischain.com/"
const val POLYGON_ENDPOINT = "https://polygon-rpc.com/"
const val BNB_ENDPOINT = "https://bsc-dataseed2.binance.org/"
const val KILN_ENDPOINT = "https://rpc.kiln.themerge.dev/"
const val MUMBAI_ENDPOINT = "https://matic-mumbai.chainstacklabs.com/"
const val CHAPEL_ENDPOINT = "https://data-seed-prebsc-1-s1.binance.org:8545/"
const val CHAIN_ID_MAINNET = 1L
const val CHAIN_ID_POLYGON = 137L
const val CHAIN_ID_BNB = 56L
...
const val CHAIN_ID_KILN = 1337802L
const val CHAIN_ID_MUMBAI = 800001L
const val CHAIN_ID_CHAPEL = 97L
...
val CHAIN_IDS = listOf(CHAIN_ID_MAINNET, CHAIN_ID_XDAI, CHAIN_ID_POLYGON, CHAIN_ID_BNB, CHAIN_ID_ROPSTEN, CHAIN_ID_RINKEBY, CHAIN_ID_GOERLI, CHAIN_ID_KOVAN, CHAIN_ID_KILN, CHAIN_ID_MUMBAI, CHAIN_ID_CHAPEL)
